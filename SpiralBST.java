...
class BST
{
    ...
    public void spiralTraverse()
    {
        ...
        {
            printSpiralTraverse(getRoot(), i, b);
            b = !b;
    ...
    public void printSpiralTraverse(Node root, int level, boolean b)
    {
        if(root == null)
            return;
        ...
        if(level > 1 && b == false)
        {
            printSpiralTraverse(root.left, level-1, b);
            printSpiralTraverse(root.right, level-1, b);
        }
